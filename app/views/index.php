...
<body>
  ...
  <div class="container-fliud bg-white my-4">
    <div class="d-flex col-12">
      ...
      <div class="col-6" id="section1_landing">
      ...
      <div class="col-6" id="section2_landing">
        <img src="assets/img/img-body.png" class="img-responsive" id="img_body_landing_page" alt="image landing page">
      </div>
    </div>
  </div>
